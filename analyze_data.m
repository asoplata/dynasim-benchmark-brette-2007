...
hold on
loglog(data.CellCount, data.BrianCOBAHH_Nosyn_Compiled, '-og')
...
hold on
loglog(data.CellCount, data.BrianCOBAHH_ClocksynLodensEstimated_Compiled, '-og')
...
hold on
loglog(data.CellCount, data.BrianCOBAHH_ClocksynHidensEstimated_Compiled, '-og')
